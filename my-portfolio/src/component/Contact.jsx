    ...
    <div id='contact' className='width my-32 flex items-center justify-center gap-16 max-Laptop:gap-7'>
      <div className=' bg-[#313036] w-[50%] p-6 flex flex-col gap-10 max-Laptop:w-[70%] max-Laptop:gap-5'>
        <div className=' flex flex-col gap-3'>
          ...
          <p className='text-[#BDBDC1] text-[14px] w-[70%]'>"Got an idea, a project, or just want to build something cool together? I'm all ears—let's make it happen."</p>
        </div>
    <div className=' flex gap-5 flex-col'>
      <div className='flex gap-4'>
        <input className=' w-1/2 bg-[#1C1B22] py-3 pl-3 text-[#BDBDC1] placeholder:text-[#BDBDC1] text-[12px] placeholder:text-[11px] rounded' type="text" placeholder='FirstName'/>
        <input className=' w-1/2 bg-[#1C1B22] py-3 pl-3 text-[#BDBDC1] placeholder:text-[#BDBDC1] text-[12px] placeholder:text-[11px] rounded' type="text" placeholder='LastName'/>
      </div>
      <div className='flex gap-4'>
        <input className=' w-1/2 bg-[#1C1B22] py-3 pl-3 text-[#BDBDC1] placeholder:text-[#BDBDC1] text-[12px] placeholder:text-[11px] rounded' type="email" placeholder='Email'/>
        <input className=' w-1/2 bg-[#1C1B22] py-3 pl-3 text-[#BDBDC1] placeholder:text-[#BDBDC1] text-[12px] placeholder:text-[11px] rounded' type="phone" placeholder='Phone Number'/>
      </div>
    ...
    <button className=' text-black bg-[#00FD9A] py-2 hover:border-2 hover:text-white transition-colors duration-400 ease-in-out hover:border-[#00FD9A] hover:bg-[#00FD9A00]'>Send message</button>
      ...
      <div className=' flex flex-col gap-9 w-[32%] max-Laptop:w-[30%] max-Laptop:gap-6'>
        <div className=' flex items-center gap-4 max-Laptop:flex-col max-Laptop:items-start max-Laptop:gap-2'>
          ...
          <div className=' text-white text-[17px] max-Laptop:text-[13px]'>
