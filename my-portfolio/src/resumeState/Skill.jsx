    ...
    <div>
      <div className="mb-8">
        <motion.h2
          ...
          className='text-white text-[43px] max-mobile:text-[32px] font-bold mb-3'
        >
          My Tech Stack
        </motion.h2>
        <motion.p
          ...
          className='text-[15px] text-[#BDBDC1] leading-7 mb-5 max-Laptop:leading-6 max-mobile:mb-7 max-w-2xl'
        >
      ...
      <motion.div
        ...
        className="mt-10 flex gap-6 flex-wrap max-mobile:gap-3 max-mobile:mt-6"
      >
