...
const Skill = () => {
  return (
          ...
          <div className=' grid grid-cols-4 gap-5 w-[560px]'>
            <div className=' bg-gray-600 w-[120px] h-[120px] items-center flex justify-center py-5 text-white hover:text-[#00FD9A] transition-colors ease-in-out duration-400 rounded'>
              <FaHtml5  size={50}/>
            </div>
            <div className=' bg-gray-600 w-[120px] h-[120px] items-center flex justify-center py-5 text-white hover:text-[#00FD9A] transition-colors ease-in-out duration-400 rounded'>
